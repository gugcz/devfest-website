      ...
      <v-col md="11" sm="11" lg="9" class="google-font my-md-7 my-2 py-md-8 py-1">
        <v-container fluid>
          ...
          <v-row justify="center" align="center" v-if="!isLoggedinUser && !MainViewLoader && !isDevProfile">
            <v-col md="7" lg="7" cols="12" sm="12" class="pb-4">
              <p class="h1-heading">DevFest Profile</p>
              <p style="font-size:20px" class="mb-5">
                DevFest profile is synonymous to your professional profile. It is your unique bio on the Devfest platform. This enables you to connect with speakers, recruiters and attendees to maximise your potential in achieving what you seek. You can also share this profile to showcase your projects, skills and achievements.
              </p>
              <Auth loginSubContent='Sign in and Create your DevFest Profile.'/>
            </v-col>
            <v-col md="5" lg="5">
              <v-img
                alt="Vuetify Logo"
...
export default {
  ...
  created(){
    document.title = 'DevFest Profile | DevFest.cz 2021'
    this.checkStatus()
  },
  methods:{
    async checkStatus(){
