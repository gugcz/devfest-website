 ...
 * the full profile isn't in the server-provided `speakersById` map (fallback).
 */
...
export default function SessionDetail({
	...
	const openSpeaker = useCallback(
		(ref: SessionSpeakerRef) => {
			// Prefer the full server-provided profile (bio, links, talks); fall back
			// to the session's embedded summary if it isn't in the map. No client
			// Firestore read — the data is already on the page.
