/**
 * Configuration parameters for the speakers domain.
 *
 * Secrets are stored in Secret Manager and configured with
 *   firebase functions:secrets:set <NAME>
 *
 * The Slack webhook is NOT redefined here — `refresh-speakers.ts` imports
...
// Sessionize JSON endpoint id for the DevFest.cz event's Speakers view.
...
// as JSON format with the Speakers view — an embed id returns HTML, not JSON.
// Fetched at: https://sessionize.com/api/v2/<id>/view/Speakers
