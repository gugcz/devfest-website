...
/**
 * Find or create company in facturoid
 */
...
/**
 * Processsing of payment of facturoid
 */
...
/**
 * Get current exchange rate on call
 */
export const getCurrentExchangeRate = functions.https.onCall((data) => {
 ...
 */
export const getCurrentCompanyFundedPrice = functions.https.onCall(() => {
