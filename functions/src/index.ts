...
export const syncChangedSections = sync.changedSections;
export const syncChangedPartners = sync.changedPartners;
export const syncChangedSpeakers = sync.changedSpeakers;
export const syncChangedSessions = sync.changedSessions;
export const syncChangedTimeSlots = sync.changedTimeSlots;
